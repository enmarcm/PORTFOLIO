...
const Init = () => {
  return (
    <section className="relative w-full min-h-screen bg-primary py-14">
      ...
      <div className="relative w-10/12 mx-auto flex z-20 sm:flex-col md:flex-row">
        <div className="sm:w-full md:w-7/12 flex flex-col ">
        ...
        <div className="sm:w-full md:w-5/12 flex flex-col items-center justify-center ">
